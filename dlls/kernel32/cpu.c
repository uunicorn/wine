...
const BYTE rsmbInfo[] = {
    0x41, // Used20CallingMethod
    0x42, // SMBIOSMajorVersion
    0x43, // SMBIOSMinorVersion
    0x44, // DmiRevision
    0x79, 0x00, 0x00, 0x00, // Length
 0x01, 0x1B, 0x0C, 0x00, 0x01, 0x02, 0x03, 0x04, 0x4C, 0x6E, 0x9C, 0x09, 0xC8, 0x2D, 0xB2, 0x11,
 0xA8, 0x5C, 0xDB, 0x86, 0xFB, 0x95, 0xC0, 0x01, 0x06, 0x05, 0x06,
/* Manufacturer  */ 0x4C, 0x45, 0x4E, 0x4F, 0x56, 0x4F, 0x00,
/* Product Name  */ 'V', 'i', 'r', 't', 'u', 'a', 'l', 'B', 'o', 'x', 0x00,
/* Version       */ 0x54, 0x68, 0x69, 0x6E, 0x6B, 0x50, 0x61, 0x64, 0x20, 0x54, 0x34, 0x37, 0x30, 0x00,
/* Serial Number */ '0', 0x00,
/* SKU Number    */ 0x4C, 0x45, 0x4E, 0x4F, 0x56, 0x4F, 0x5F, 0x4D, 0x54, 0x5F, 0x32, 0x30, 0x48, 0x44, 0x5F, 0x42,
0x55, 0x5F, 0x54, 0x68, 0x69, 0x6E, 0x6B, 0x5F, 0x46, 0x4D, 0x5F, 0x54, 0x68, 0x69, 0x6E, 0x6B,
0x50, 0x61, 0x64, 0x20, 0x54, 0x34, 0x37, 0x30, 0x00,
/* Family        */ 0x54, 0x68, 0x69, 0x6E, 0x6B, 0x50, 0x61, 0x64, 0x20, 0x54, 0x34, 0x37, 0x30, 0x00, 0x00,
       0xff,
       0x00,
       0xff, 0xff
};
...
{
    if(0x52534d42 == provider && 0x50434146 == id) {
        if(buffer && size >= sizeof(rsmbInfo)) {
            memcpy(buffer, rsmbInfo, sizeof(rsmbInfo));
        }

        return sizeof(rsmbInfo);
    }
